                        ...
                        <div class="aside-user-info flex-row-fluid flex-wrap ms-5">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1 me-2">
                                    <!--begin::Username-->
                                    <a href="#"
                                        class="text-white text-hover-primary fs-6 fw-bold">{{ Str::title(Auth::user()->name) }}</a>
                                    <!--end::Username-->
                                    <!--begin::Description-->
                                    <span
                                        ...
                                        <div class="menu-item px-3">
                                            <div class="menu-content d-flex align-items-center px-3">
                                                ...
                                                <div class="d-flex flex-column">
                                                    ...
                                                    {{-- <a href="#" --}}
                                                    {{-- class="fw-bold text-muted text-hover-primary fs-7">{{ Str::title(Auth::user()->email) }}</a> --}}
                                                </div>
                                                <!--end::Username-->
                                            </div>
                                        </div>
                    ...
                    <div class="aside-menu flex-column-fluid">
                        ...
                        <div class="hover-scroll-overlay-y px-2 my-5 my-lg-5" id="kt_aside_menu_wrapper"
                            ...
                            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                                ...
                                <div data-kt-menu-trigger="click"
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        <div data-kt-menu-trigger="click"
                                            ...
                                            <div class="menu-sub menu-sub-accordion">
                                                <div class="menu-item ">
                                                    <a class="menu-link {{ menuActive('user.list') }}"
                                ...
                                <div class="menu-item">
                                    <a class="menu-link {{ menuActive('PPOB.index') }} "
                                        href="{{ route('PPOB.index') }}" data-bs-toggle="tooltip"
                                ...
                                <div class="menu-item">
                                    <a class="menu-link {{ menuActive('pengaturan') }} "
                                        href="{{ route('pengaturan') }}" data-bs-toggle="tooltip"
                                        data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                                        <span class="menu-icon">
                ...
                @if (Auth::user()->role == 'siswa' && Auth::user()->status_akun == 1)
                    ...
                    <div class="aside-footer flex-column-auto py-5" id="kt_aside_footer">
                        <a href="" class="btn btn-custom btn-primary w-100" data-bs-toggle="tooltip"
                            data-bs-trigger="hover" data-bs-dismiss-="click" title="Sistem Informasi Akademik">
                            <span class="btn-label">SIAKAD</span>
