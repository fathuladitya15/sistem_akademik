            ...
            <tr>
                <td align="center" valign="center" style="text-align:center; padding: 40px">
                    <a href="#" rel="noopener" target="_blank">
                        <img alt="Logo" src="{{ asset('assets/media/logos/logo-1.svg') }}" class="h-45px" />
                    </a>
                </td>
            </tr>
            <tr>
                <td align="left" valign="center">
                    <div
                        ...
                        <div style="padding-bottom: 50px; word-break: break-all;">
                            ...
                            <a href="{{ $actionUrl }}" rel="noopener" target="_blank"
                                style="text-decoration:none;color: #009EF7;word-break: break-all;">{{ $actionUrl }}</a>
                        </div>
                        <!--end:Email content-->
